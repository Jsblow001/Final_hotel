...
본 프로젝트에서 담당한 **예약 시스템, 프로모션 관리, 고객 소통 및 통계** 부문의 데이터베이스 설계도입니다.

- **담당 범위:** 예약(Reservation), 프로모션(Promotion), Q&A/FAQ/공지사항, 매출 통계(Stats)
...
<div align="center">
  <table style="border: none; border-collapse: collapse;">
    ...
    <tr>
      <td align="center" colspan="2" style="border: none; padding-top: 20px;">
        <p>▲ 브랜드 아이덴티티를 강조한 메인 레이아웃 및 실시간 할인 로직 연동 화면</p>
      </td>
    </tr>
  </table>
</div>
